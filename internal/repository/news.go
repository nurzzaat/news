...
func (r *NewsRepository) Edit(c context.Context, news models.NewsRequest) error {
	...
	if _, err := r.db.Exec(c, query, news.Title, news.Content, news.CategoryID, news.ThumbNail, news.ID, models.ADMIN_ID); err != nil {
		return err
	}
	return nil
}
func (r *NewsRepository) Delete(c context.Context, newsID int) error {
	...
	if _, err := r.db.Exec(c, query, newsID, models.ADMIN_ID); err != nil {
		return err
	}
	return nil
}
...
func ClearNews(c context.Context, db *pgxpool.Pool) error {
	...
	if _, err := db.Exec(c, query, models.ADMIN_ID); err != nil {
		return err
	}
	return nil
}
